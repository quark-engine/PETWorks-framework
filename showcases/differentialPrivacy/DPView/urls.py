...
urlpatterns = [
	...
	path('execute', views.DPViewView.as_view(), name = 'execute'),
    path('break_program/', views.BreakProgramView.as_view(), name = 'break_program'),
	path('show_progress/', DP_View.show_progress, name = 'show_progress'),
    ...
    path('custom/<str:csv_name>/', views.CustomView.as_view()),
    path('create_DPView_json/', json_parser_views.DPViewParserView.as_view(), name = 'create_json'),
    path('advanced_settings/<str:csv_name>/', views.AdvancedSettingsView.as_view(), name = 'advanced_settings'),
]
